...
const AchievementsScreen = ({ navigation }) => {
  ...
  // Trophy data based on selected category
  const trophyData = {
    stars: [
      {
        id: "bronze",
  ...
  // Function to render trophy items based on category
  const renderTrophies = () => {
    const trophies = trophyData[selectedCategory] || [];

    // Special rendering for medal-style trophies
    ...
    // Standard grid layout for other trophy types
    return (
        ...
        <BottomTabBar
          ...
          onTabPress={(tabId) => {
            if (tabId === "home") {
              ...
              // Handle profile navigation when available
            }
          }}
        />
      </SafeAreaView>
